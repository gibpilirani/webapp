...
4. Open your browser to type localhost/phpmyadmin. Make sure your apache server and mysqlservices are started. The localhost       default port is 80. But if you have other programs using port 80, you can change your environment to 81 etc in the       httpd.config file.
...
8. Then enjoy the project
9. Any question or clarification please contact gibson.dzimbiri@gmail.com
