...
if(isset($_POST['email'])) {
  ...
  if ($email != $c_email) {
    ...
    if(!isset($_FILES['profile-image']) || $_FILES['profile-image']['error'] == UPLOAD_ERR_NO_FILE) {
      ...
      //Update user method
      $update = $userData->editProfile($id, $lastname, $firstname, $email, $profile_image, $gender, $telephone, $designation);
      ...
      } else if ($_FILES['profile-image']['size'] > 1000000) { 
        // file shouldn't be larger than 1Megabyte
        exit('The image is too large');
      } else {
        // Move the uploaded (temporary) file to the specified destination
        if (move_uploaded_file($file, $destination)) {
          $update_user = $userData->updateUsers($id, $lastname, $firstname, $email, $profile_image, $gender, $telephone, $designation);
          $update_address = $userData->update_address($address_id, $address_one, $city, $country, $zip);
          if($update_user) {
            /*$response['status'] = 5; 
            ...
            <div class="accordion" id="accordion" >
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  <p><span class="firstnameMsg hidden text-danger">Please Enter a valid LastName</span></p>
                </div>
              </div>
              ...
              <div class="form-group row">        
                ...
                <div class="col-md-6">
                  <label for="phone_number" class="col-md-8 col-form-label">Gender<span class="text-danger">*</span></label>
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  ...
                  <input type="tel" id="telephone" class="form-control city" name="telephone" placeholder="123-4567-8901" value="<?php echo $contact;?>" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}">
              ...
              <div class="form-group row">
                ...
                <!--Zip code -->
                <div class="col-md-6">
                  <label for="permanent_address" class="col-md-6 col-form-label">Postal / Zip Code <span class="text-danger">*</span></label>
            ...
            <?php if($_SESSION['type'] =='admin') { ?>
              <div class="form-radio update-radio">
                <label class="radio-inline">
                  <input type="radio" hidden id="status" name="status" value="pending" <?php if($status =="pending"){ echo "checked";}?>/> <!--Pending-->
                </label>
                <label class="radio-inline">
                  <input type="radio" hidden id="status" name="status" value="active" <?php if($status=="active"){ echo "checked";}?>/><!-- Activate -->
                </label>
                <label class="radio-inline">
                  <input type="radio" hidden id="status" name="status" value="disabled" <?php if($status=="disabled"){ echo "checked";}?>/><!-- Disabled -->
                </label>
              </div>
    ...
    $("#update-btn").click(function(){
      ...
      $.ajax({
        ...
        success:function(response) {
          ...
          if(response == 1) {
            $(".update-data").show().html('<span class="text-primary">Data updated successfully</span>');
            $("#my-form").hide();
          }else if(response == 2){
