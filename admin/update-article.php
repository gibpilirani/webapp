...
<!--END OF HEADER-->
<?php 
//Provide access to edit form if user is an admin or editor
if( isset($_SESSION['loggedin']) && ($_SESSION['type'] == 'admin')) {?>
  ...
  <div class="row">
    ...
    <div class="mt-5 mb-5">
      ...
      <hr class="line">
      <span class="updateMsg text-primary"></span>
      <div class="card-body" id="my-form">
        <form method="post" action="update-article.php" enctype="multipart/form-data">
          ...
          <?php if( isset($_SESSION['loggedin']) && ($_SESSION['type'] == 'admin' OR $_SESSION['type'] == 'editor' ) ) {?>
            ...
            <div class="form-group row">
              <div class="col-sm-10">
                <input type="button" id="update-btn" name="update-btn" class="btn btn-primary" value="Update">
      ...
      $("#update-btn").click(function(){
        ...
        $.ajax({
          ...
          success:function(response) {
            ...
            if(response == 1) {
              $(".updateMsg").show().html('<span class="text-primary">Data updated successfully</span>');
              $("#my-form").hide();
            }else if(response == 3){
