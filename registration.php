...
<div class="container">
  ...
  <div class="signUpMsg" style="height: 200px"></div>
    <div class="col-md-8">
      <div class="mt-5 mb-5" id="hide">
        <div class="text-center">
          <h2>Create an account</h2>
          <hr class="line">
        </div>
        <div id="signUpMsg"></div>
        <img id="loading" src="images/hb.gif"/> <!– Loading Image –>
        <div class="card-body">
            ...
            <div class="accordion" id="accordion" >
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  ...
                  <span class="error-addressOne text-danger"></span>
                  <span class="length hidden text-danger"></span>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  <span class="zip hidden text-danger"></span>
                  <span class="error-zip text-danger"></span>
